...
namespace TodoWebService.Services
{
    public class TodoService : ITodoService
    {
        ...
        public async Task<List<TodoItem>> GetAllTodoItems() => await _context.TodoItems.ToListAsync();

        public async Task<bool> UpdateTodoItemNotify(int id, bool notify)
        {
